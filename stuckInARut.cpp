    ...
    /*while(time<1000000)
    {
        for(int i=0; i<n; i++)
        {
            ...
            if(cowResolved[i]==false)
            {
                ...
                if(xCoord[i]==xRut[i] && yCoord[i]==yRut[i])
                {
                    cowResolved[i]=true;
                }
                if(cowResolved[i]==false)
                {
                    ...
                    if(directions[i]=='N')
                    {
                        for(int j=0; j<n; j++)
                        {
                            if(directions[j]=='E' && xCoord[j]<xCoord[i] && yCoord[j]>yCoord[i])
                            {
                                flag++;
                                break;
                            } else {
                    ...
                    if(directions[i]=='E')
                    {
                        for(int j=0; j<n; j++)
                        {
                            if(directions[j]=='N' && xCoord[j]>xCoord[i] && yCoord[j]<yCoord[i])
                            {
                                flag++;
                                break;
                            } else {
        ...
        /*for(int a=0; a<n; a++)
        {
            if(cowResolved[a]==false)
            {
                alsoflag++;
            }
        }
        if(alsoflag==0) resolved=true;
        time++;
    }
    for(int i=0; i<n; i++)
    {
